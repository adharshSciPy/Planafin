...
function SolutionDataFull() {
    ...
    const handleOk = async () => {
      ...
      try {
        ...
        const response = await axios.delete(
          `${baseUrl}/api/v1/user/deleteBusinessPlanning/${selectId}`
        );
    ...
    const getData = async () => {
      try {
        const response = await axios.get(`${baseUrl}/api/v1/user/getBusinessPlanning`);
...
export default SolutionDataFull

...
import picture from "../../assets/2-Budgeting-Infographic-scaled.jpg";
              ...
              <div className={styles.leftMain}>
                ...
                <div className={styles.heading}>
                  <h2 className={styles.firstContentH}>
                    S&OP Series: Episode 2 –<br></br> Budgeting
                  </h2>
                </div>
                <div>
          ...
          <div className={styles.mainFirstTwoSub}>
            <div className={styles.mainFirstTwoSubLeft}>
              <div className={styles.twoMainLeft}>
                ...
                <p>
                  This is the second episode from our S&OP Series which
                  demonstrates ‘Budgeting’ application built on Pigment. It
                  showcases Sales Budgeting, Manpower Budgeting, Operations
                  Budgeting, and the overall Financial Budgeting. With every
                  episode, we will continue to showcase important components of
                  an end-to-end ‘Sales and Operations Planning’ application
                  built on Pigment. This video provides a detailed demonstration
                  of step-by-step tasks for planning Budgets by every department
                  within an organization. The application is curated by
                  Planafin’s experienced techno-functional consultants and
                  domain experts.
                </p>
                <p>
                ...
                <ul>
                  ...
                  <li className={styles.containerTwoLi}>Manufacturing Heads</li>
                  <li className={styles.containerTwoLi}>Capacity Planners</li>
                  <li className={styles.containerTwoLi}>Production Planners</li>
                  <li className={styles.containerTwoLi}>
                    Material Resource Planners
                  </li>
                  <li className={styles.containerTwoLi}>
                    Operations Manager / Operations Planners
                  </li>
                </ul>
                <p>

...
import picture from "../../assets/3-Demand-Forecasting-Infographic-scaled.jpg";
            ...
            <div className={styles.firstLeft}>
              <div className={styles.leftMain}>
                ...
                <div className={styles.heading}>
                  ...
                  S&OP Series: Episode 3 – Demand Forecasting
          ...
          <div className={styles.mainFirstTwoSub}>
            <div className={styles.mainFirstTwoSubLeft}>
              <div className={styles.twoMainLeft}>
                ...
                <p>
                 This session is our main event. It is the third episode from our S&OP Series which demonstrates ‘Demand Forecasting’ application built on Pigment. It showcases Product Lifecycle Management, Sales Collaboration, Statistical Forecasting, Demand Planning, and much more. With every episode, we’ll continue to showcase important components of an end-to-end ‘Sales and Operations Planning’
                  application built on Pigment. This video provides a
                   detailed demonstration of step-by-step tasks for 
                   Demand Forecasting and collaboration with 
                   cross-functional teams. The application is 
                   curated by Planafin’s experienced techno-functional 
                ...
                <ul>
                  ...
                  <li className={styles.containerTwoLi}>Sales Managers</li>
                    <li className={styles.containerTwoLi}>Marketing Managers / Product Managers / Brand Managers</li>
                  <li className={styles.containerTwoLi}>
